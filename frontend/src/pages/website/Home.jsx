...
import { Sparkles, Send, ArrowRight, BookOpen, TrendingUp, BarChart2, Plus, ArrowUpRight, TrendingDown, Activity, Newspaper, Landmark, Mic, ChevronLeft, ChevronRight, ShieldCheck, Scale } from 'lucide-react';
          ...
          <div className="w-full flex flex-col items-center">
            ...
            >
              ...
              <motion.div
                ...
                className="liquid-glass lg:col-span-5 w-full rounded-3xl p-6 relative"
              >
            ...
            <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: "-50px" }} variants={itemVariants} className="liquid-glass w-full py-10 px-6 sm:px-10 mb-10 rounded-[32px]">
              <div className="flex items-end justify-between mb-8">
                ...
                <div className="flex items-center gap-2">
                  <button onClick={scrollLeft} className="w-10 h-10 rounded-full border border-gray-200 dark:border-gray-800 flex items-center justify-center bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800 text-gray-600 dark:text-gray-400 transition-colors">
                    <ChevronLeft size={20} />
                  </button>
                  <button onClick={scrollRight} className="w-10 h-10 rounded-full border border-gray-200 dark:border-gray-800 flex items-center justify-center bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800 text-gray-600 dark:text-gray-400 transition-colors">
              ...
              <div ref={sliderRef} className="flex gap-6 overflow-x-auto snap-x snap-mandatory pb-4" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                ...
                <motion.div onClick={() => navigate('/investors-strategy')} whileHover={{ y: -6, scale: 1.01, boxShadow: '0 16px 40px rgba(249,115,22,0.14)' }} transition={{ duration: 0.3, ease: 'easeOut' }} className="liquid-glass min-w-[280px] w-[280px] md:min-w-[320px] shrink-0 snap-start p-5 rounded-2xl transition-all flex flex-col items-start cursor-pointer group">
                ...
                <motion.div onClick={() => navigate('/compare')} whileHover={{ y: -6, scale: 1.01, boxShadow: '0 16px 40px rgba(37,99,235,0.14)' }} transition={{ duration: 0.3, ease: 'easeOut' }} className="liquid-glass min-w-[280px] w-[280px] md:min-w-[320px] shrink-0 snap-start p-5 rounded-2xl transition-all flex flex-col items-start cursor-pointer group">
                ...
                <motion.div onClick={() => navigate('/watchlist')} whileHover={{ y: -6, scale: 1.01, boxShadow: '0 16px 40px rgba(22,163,74,0.14)' }} transition={{ duration: 0.3, ease: 'easeOut' }} className="liquid-glass min-w-[280px] w-[280px] md:min-w-[320px] shrink-0 snap-start p-5 rounded-2xl transition-all flex flex-col items-start cursor-pointer group">
                ...
                <motion.div onClick={() => navigate('/watchlist')} whileHover={{ y: -6, scale: 1.01, boxShadow: '0 16px 40px rgba(99,102,241,0.14)' }} transition={{ duration: 0.3, ease: 'easeOut' }} className="liquid-glass min-w-[280px] w-[280px] md:min-w-[320px] shrink-0 snap-start p-5 rounded-2xl transition-all flex flex-col items-start cursor-pointer group">
            ...
            {cmsConfig?.pages?.home?.features?.showFeaturedNews && featuredNews && (
              <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: "-50px" }} variants={itemVariants} className="w-full mb-6">
                <div
                  className="liquid-glass rounded-[22px] overflow-hidden cursor-pointer hover:shadow-md transition-all duration-300 grid grid-cols-1 md:grid-cols-3"
            ...
            <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: "-50px" }} variants={itemVariants} className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[24px] mb-12">
              {cmsConfig?.pages?.home?.features?.showTrendingStocks && (
                <motion.div whileHover={{ y: -6, scale: 1.01, boxShadow: '0 10px 30px rgba(37,99,235,0.08)' }} transition={{ duration: 0.3, ease: 'easeOut' }} className="liquid-glass rounded-[22px] p-[24px] h-[290px] transition-all duration-300 flex flex-col justify-center cursor-default">
              ...
              {cmsConfig?.pages?.home?.features?.showMarketPulse && (
                <motion.div whileHover={{ y: -6, scale: 1.01, boxShadow: '0 10px 30px rgba(37,99,235,0.08)' }} transition={{ duration: 0.3, ease: 'easeOut' }} className="liquid-glass rounded-[22px] p-[24px] h-[290px] transition-all duration-300 flex flex-col">
            ...
            <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: "-50px" }} variants={itemVariants} className="liquid-glass w-full rounded-[22px] p-[24px] mb-12">
            ...
            <motion.div variants={itemVariants} className="w-full grid grid-cols-1 md:grid-cols-3 gap-[24px] mb-12">
              <div onClick={() => navigate('/amcs')} className="liquid-glass rounded-[22px] p-[24px] hover:shadow-md transition-all cursor-pointer flex flex-col gap-3">
              ...
              <div onClick={() => navigate('/watchlist')} className="liquid-glass rounded-[22px] p-[24px] hover:shadow-md transition-all cursor-pointer flex flex-col gap-3">
              ...
              <div onClick={() => navigate('/compare')} className="liquid-glass rounded-[22px] p-[24px] hover:shadow-md transition-all cursor-pointer flex flex-col gap-3">
