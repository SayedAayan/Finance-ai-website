      ...
      >
        <div className="container h-[80px] flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              to="/junior"
              className="flex items-center justify-center gap-1.5 whitespace-nowrap bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-500 hover:to-amber-600 text-slate-950 px-3.5 h-[38px] rounded-full font-bold text-xs shadow-sm hover:shadow-md transition-all duration-200 hover:scale-105 active:scale-95 flex-shrink-0"
            ...
            {currentUser ? (
              <div className="relative flex-shrink-0" ref={userMenuRef}>
                <button
                  ...
                  className="flex items-center justify-center w-[38px] h-[38px] rounded-full bg-gradient-to-br from-violet-500 to-indigo-600 text-white font-bold text-sm overflow-hidden flex-shrink-0"
              ...
              <Link
                to="/login"
                className="flex items-center justify-center whitespace-nowrap bg-gradient-to-r from-blue-600 via-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white px-4 h-[38px] rounded-full font-semibold text-[0.82rem] shadow-sm hover:shadow-md transition-all duration-200 hover:scale-105 active:scale-95 flex-shrink-0"
              >
                Sign in
              </Link>
            )}
