...
export const defaultCmsConfig = {
  ...
  navbar: {
    navItems: [
      ...
      { id: '5', label: 'Others ▾', subItems: [
        ...
        { id: '5-2', label: 'Mutual Funds', path: '/mutual-funds' },
      ]}
    ],
  ...
  footer: {
    logo: '',
    tagline: 'AI-powered research for Indian retail investors. We explain, compare, and source every answer — never recommend.',
    columns: [
      { id: 'c1', title: 'Research', links: [ { id: 'l1', label: 'Stocks', path: '/markets' }, { id: 'l2', label: 'Mutual Funds', path: '/mutual-funds' } ] },
      { id: 'c2', title: 'Learn', links: [ { id: 'l3', label: 'Market Basics', path: '#' }, { id: 'l4', label: 'Glossary', path: '#' } ] },
      { id: 'c3', title: 'Company', links: [ { id: 'l5', label: 'About Us', path: '#' }, { id: 'l6', label: 'Contact', path: '#' } ] }
    ],
