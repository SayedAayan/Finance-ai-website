          ...
          <div className="w-full flex flex-col items-center">
            ...
            <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: "-50px" }} variants={itemVariants} className="liquid-glass w-full py-10 px-6 sm:px-10 mb-10 rounded-[32px]">
              ...
              <div ref={sliderRef} className="flex gap-6 overflow-x-auto snap-x snap-mandatory pb-4" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                ...
                <motion.div onClick={() => navigate('/investors-strategy')} whileHover={{ y: -6, scale: 1.01, borderColor: '#f97316', boxShadow: '0 10px 30px rgba(249,115,22,0.08)' }} transition={{ duration: 0.3, ease: 'easeOut' }} className="liquid-glass min-w-[280px] w-[280px] md:min-w-[320px] shrink-0 snap-start p-5 rounded-2xl hover:shadow-xl transition-all flex flex-col items-start cursor-pointer group">
                ...
                <motion.div onClick={() => navigate('/watchlist')} whileHover={{ y: -6, scale: 1.01, borderColor: '#6366f1', boxShadow: '0 10px 30px rgba(99,102,241,0.08)' }} transition={{ duration: 0.3, ease: 'easeOut' }} className="liquid-glass min-w-[280px] w-[280px] md:min-w-[320px] shrink-0 snap-start p-5 rounded-2xl hover:shadow-xl transition-all flex flex-col items-start cursor-pointer group">
